...
export default function HomePage() {
  ...
  const domainTab2 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        />
        <ActionMemo
          persona={{ name: 'Vietnam Operations Lead', role: 'Director of Order' }}
          context={{}}
          onGenerate={async () => ({
            subject: 'Action Required',
            body: 'AI-generated recommendation based on current data patterns and predicted trends.',
            urgency: 'HIGH',
            actions: ['Review top order delays findings', 'Optimize factory allocation', 'Prepare quarterly order report'],
          })}
        />
      </div>
    </div>
  ...
  const tabs = [
    ...
    { id: 'domain-1', label: 'Order Analytics', icon: '📈', content: domainTab1 },
